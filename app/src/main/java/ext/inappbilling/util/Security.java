...
public class Security {
  ...
  public static boolean verifyPurchase(String base64PublicKey, String signedData, String signature) {
    // TODO attask-133300 remove this check after done with using dummy static product IDs
    // This is added because with dummy products like "android.test.purchased" we are not getting a signature
